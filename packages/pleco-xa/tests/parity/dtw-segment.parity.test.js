...
describe('dtw parity vs librosa 0.11 (librosa.sequence.dtw, default params)', () => {
  ...
  it('warping path exact (librosa end-to-start order)', () => {
    const { wp } = dtw(X, Y)
...
describe('segment parity vs librosa 0.11 (librosa.segment.*)', () => {
