...
function run(input) {
  switch (input.fn) {
    ...
    case 'amplitude_to_db': return convert.amplitude_to_db(input.S, input.ref, 1e-10, null)
    case 'power_to_db': return convert.power_to_db(input.S, input.ref, 1e-12, null)
