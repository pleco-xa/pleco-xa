...
describe('golden: stft magnitude vs committed reference fixture', () => {
  const fx = loadFixture('stft')
  for (const c of fx.cases) {
    it(`stft(${c.input.signal}) magnitudes match reference ground truth (n_fft=512, hop=128)`, () => {
...
describe('golden: istft(stft(y)) round-trip', () => {
