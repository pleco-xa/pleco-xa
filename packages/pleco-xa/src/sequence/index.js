...
// Viterbi decoding. Discriminative decode applies Bayes' rule: likelihood ∝
// P(state|obs) / p_state (DIVIDE by the prior; a legacy copy multiplied it).
// viterbi_binary is intentionally NOT promoted: it is not a per-label
...
// transition_local follows the get_window→pad_center→roll pipeline.
export {
  transition_uniform,
  transition_loop,
  transition_cycle,
