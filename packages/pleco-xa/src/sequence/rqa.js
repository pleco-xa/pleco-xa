 ...
 *
 * Line-faithful port of librosa 0.11 `librosa.sequence.rqa` (sequence.py),
 * implementing the methods of Serrà, Serra & Andrzejak (2009): dynamic
 ...
 *
 * Parity: fixture-gated against tools/parity/fixtures/rqa.json
 * (exact path agreement + score max, generated by librosa 0.11.0).
 *
...
/**
 * RQA dynamic-programming core (port of librosa __rqa_dp).
 *
 * Backtracking rubric (matches librosa exactly):
 *    0 ==> diagonal move (-1, -1)
 *    1 ==> knight move (-1, -2)
 *    2 ==> knight move (-2, -1)
...
/**
 * RQA path backtracking (port of librosa __rqa_backtrack).
 */
