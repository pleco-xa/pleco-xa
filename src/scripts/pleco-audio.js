...
export const info = {
  ...
  jsApplicableFunctions: 459,
  notApplicableFunctions: 53,
  remainingToImplement: 0,
  note: 'Librosa Feature Parity: 100% COMPLETE - All 459 JavaScript-applicable functions implemented (512 total, 53 N/A Python/Matplotlib internals). Marathon implementation complete: cache, display, file I/O, music theory, advanced DSP, and all algorithmic helpers.',
  modules: [
    'Core (FFT, STFT)',
