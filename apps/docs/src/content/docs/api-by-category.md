...
The complete public API, grouped by task. Click any function for its signature, parameters, returns, and a link to the exact source line. The auto-generated per-symbol pages also live under **API Reference** in the sidebar.
